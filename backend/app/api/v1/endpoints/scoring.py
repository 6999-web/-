...
def get_evaluations_for_scoring(
    ...
    # Filter by status - default to submitted, ai_scored, manually_scored, and rejected_by_president
    if status:
        ...
        query = query.filter(SelfEvaluation.status.in_([
            ...
            "ready_for_final", "finalized", "published", "distributed", "rejected_by_president"
        ]))
