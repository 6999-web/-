    ...
    <el-card class="form-card">
      ...
      >
          ...
          <div class="content-with-attachment">
            ...
            <div class="attachment-section">
              ...
              <div v-if="teachingProcessFiles.length > 0" class="uploaded-files-list">
                <div 
                  v-for="file in teachingProcessFiles" 
                  :key="file.uid"
                  class="file-item"
                >
        ...
        >
          <div class="content-with-attachment">
            ...
            <div class="attachment-section">
              ...
              >
                <el-button type="primary" :icon="Upload">
                  附件上传 ({{ teachingQualityFiles.length }})
                </el-button>
              </el-upload>
              
              <div v-if="teachingQualityFiles.length > 0" class="uploaded-files-list">
                <div 
                  v-for="file in teachingQualityFiles" 
                  :key="file.uid"
                  class="file-item"
                >
                  <el-icon class="file-icon"><Document /></el-icon>
        ...
        >
          <div class="content-with-attachment">
            ...
            <div class="attachment-section">
              ...
              >
                <el-button type="primary" :icon="Upload">
                  附件上传 ({{ courseAssessmentFiles.length }})
                </el-button>
              </el-upload>
              
              <div v-if="courseAssessmentFiles.length > 0" class="uploaded-files-list">
                <div 
                  v-for="file in courseAssessmentFiles" 
                  :key="file.uid"
                  class="file-item"
                >
                  <el-icon class="file-icon"><Document /></el-icon>
        ...
        >
          <div class="content-with-attachment">
            ...
            <div class="attachment-section">
              ...
              >
                <el-button type="primary" :icon="Upload">
                  附件上传 ({{ educationResearchFiles.length }})
                </el-button>
              </el-upload>
              
              <div v-if="educationResearchFiles.length > 0" class="uploaded-files-list">
                <div 
                  v-for="file in educationResearchFiles" 
                  :key="file.uid"
                  class="file-item"
                >
                  <el-icon class="file-icon"><Document /></el-icon>
        ...
        >
          <div class="content-with-attachment">
            ...
            <div class="attachment-section">
              ...
              >
                <el-button type="primary" :icon="Upload">
                  附件上传 ({{ courseConstructionFiles.length }})
                </el-button>
              </el-upload>
              
              <div v-if="courseConstructionFiles.length > 0" class="uploaded-files-list">
                <div 
                  v-for="file in courseConstructionFiles" 
                  :key="file.uid"
                  class="file-item"
                >
                  <el-icon class="file-icon"><Document /></el-icon>
        ...
        >
          <div class="content-with-attachment">
            ...
            <div class="attachment-section">
              ...
              >
                <el-button type="primary" :icon="Upload">
                  附件上传 ({{ teacherTeamBuildingFiles.length }})
                </el-button>
              </el-upload>
              
              <div v-if="teacherTeamBuildingFiles.length > 0" class="uploaded-files-list">
                <div 
                  v-for="file in teacherTeamBuildingFiles" 
                  :key="file.uid"
                  class="file-item"
                >
                  <el-icon class="file-icon"><Document /></el-icon>
        ...
        >
          <div class="content-with-attachment">
            ...
            <div class="attachment-section">
              ...
              >
                <el-button type="primary" :icon="Upload">
                  附件上传 ({{ researchAndExchangeFiles.length }})
                </el-button>
              </el-upload>
              
              <div v-if="researchAndExchangeFiles.length > 0" class="uploaded-files-list">
                <div 
                  v-for="file in researchAndExchangeFiles" 
                  :key="file.uid"
                  class="file-item"
                >
                  <el-icon class="file-icon"><Document /></el-icon>
        ...
        >
          <div class="content-with-attachment">
            ...
            <div class="attachment-section">
              ...
              >
                <el-button type="primary" :icon="Upload">
                  附件上传 ({{ archiveManagementFiles.length }})
                </el-button>
              </el-upload>
              
              <div v-if="archiveManagementFiles.length > 0" class="uploaded-files-list">
                <div 
                  v-for="file in archiveManagementFiles" 
                  :key="file.uid"
                  class="file-item"
                >
                  <el-icon class="file-icon"><Document /></el-icon>
        ...
        <div class="highlight-section">
          ...
          <!-- 附件上传区域 -->
          <div class="highlight-attachment">
            <el-upload
              :auto-upload="false"
              :multiple="true"
            ...
            >
              <el-button type="primary" :icon="Upload" size="large">
                📎 上传教改项目证明材料 ({{ reformProjectsFiles.length }})
              </el-button>
            </el-upload>
            
            <div v-if="reformProjectsFiles.length > 0" class="uploaded-files-list">
              <div 
                v-for="file in reformProjectsFiles" 
                :key="file.uid"
                class="file-item"
              >
                <el-icon class="file-icon"><Document /></el-icon>
        ...
        <div class="highlight-section">
          ...
          <div class="highlight-attachment">
            ...
            >
              <el-button type="primary" :icon="Upload" size="large">
                📎 上传荣誉证书、表彰文件 ({{ teachingHonorsFiles.length }})
              </el-button>
            </el-upload>
            
            <div v-if="teachingHonorsFiles.length > 0" class="uploaded-files-list">
              <div 
                v-for="file in teachingHonorsFiles" 
                :key="file.uid"
                class="file-item"
              >
                <el-icon class="file-icon"><Document /></el-icon>
        ...
        <div class="highlight-section">
          ...
          <div class="highlight-attachment">
            ...
            >
              <el-button type="primary" :icon="Upload" size="large">
                📎 上传比赛证明材料 ({{ teachingCompetitionsFiles.length }})
              </el-button>
            </el-upload>
            
            <div v-if="teachingCompetitionsFiles.length > 0" class="uploaded-files-list">
              <div 
                v-for="file in teachingCompetitionsFiles" 
                :key="file.uid"
                class="file-item"
              >
                <el-icon class="file-icon"><Document /></el-icon>
        ...
        <div class="highlight-section">
          ...
          <div class="highlight-attachment">
            ...
            >
              <el-button type="primary" :icon="Upload" size="large">
                📎 上传比赛证明材料 ({{ innovationCompetitionsFiles.length }})
              </el-button>
            </el-upload>
            
            <div v-if="innovationCompetitionsFiles.length > 0" class="uploaded-files-list">
              <div 
                v-for="file in innovationCompetitionsFiles" 
                :key="file.uid"
                class="file-item"
              >
                <el-icon class="file-icon"><Document /></el-icon>
        ...
        <div class="negative-item">
          ...
          <!-- 附件上传区域 -->
          <div class="negative-attachment" style="margin-top: 15px;">
            <el-upload
              :auto-upload="false"
              :multiple="true"
            ...
            >
              <el-button type="warning" :icon="Upload" size="large">
                📎 上传相关说明材料 ({{ ethicsViolationsFiles.length }})
              </el-button>
            </el-upload>
            
            <div v-if="ethicsViolationsFiles.length > 0" class="uploaded-files-list">
              <div 
                v-for="file in ethicsViolationsFiles" 
                :key="file.uid"
                class="file-item"
              >
                <el-icon class="file-icon"><Document /></el-icon>
        ...
        <div class="negative-item">
          ...
          <div class="negative-attachment" style="margin-top: 15px;">
            ...
            >
              <el-button type="warning" :icon="Upload" size="large">
                📎 上传相关说明材料 ({{ teachingAccidentsFiles.length }})
              </el-button>
            </el-upload>
            
            <div v-if="teachingAccidentsFiles.length > 0" class="uploaded-files-list">
              <div 
                v-for="file in teachingAccidentsFiles" 
                :key="file.uid"
                class="file-item"
              >
                <el-icon class="file-icon"><Document /></el-icon>
        ...
        <div class="negative-item">
          ...
          <div class="negative-attachment" style="margin-top: 15px;">
            ...
            >
              <el-button type="warning" :icon="Upload" size="large">
                📎 上传相关说明材料 ({{ ideologyIssuesFiles.length }})
              </el-button>
            </el-upload>
            
            <div v-if="ideologyIssuesFiles.length > 0" class="uploaded-files-list">
              <div 
                v-for="file in ideologyIssuesFiles" 
                :key="file.uid"
                class="file-item"
              >
                <el-icon class="file-icon"><Document /></el-icon>
        ...
        <div class="negative-item">
          ...
          <div class="negative-attachment" style="margin-top: 15px;">
            ...
            >
              <el-button type="warning" :icon="Upload" size="large">
                📎 上传相关说明材料 ({{ workloadIncompleteFiles.length }})
              </el-button>
            </el-upload>
            
            <div v-if="workloadIncompleteFiles.length > 0" class="uploaded-files-list">
              <div 
                v-for="file in workloadIncompleteFiles" 
                :key="file.uid"
                class="file-item"
              >
                <el-icon class="file-icon"><Document /></el-icon>
...
// Inline attachment state for each field
...
// Highlight projects attachment state
...
// Negative list attachment state
...
/* Content with attachment layout */
...
.mini-upload :deep(.el-upload-dragger) {
  padding: 20px 10px;
  height: auto;
  min-height: 120px;
}

.mini-upload :deep(.el-icon--upload) {
  font-size: 32px;
  margin-bottom: 8px;
}

.mini-upload :deep(.el-upload__text) {
  font-size: 13px;
  line-height: 1.4;
}

.mini-upload :deep(.el-upload__tip) {
  font-size: 12px;
  line-height: 1.5;
  margin-top: 8px;
  text-align: center;
...
.attachment-section .el-button {
  width: 100%;
}

.highlight-attachment .el-button,
.negative-attachment .el-button {
  width: 100%;
  margin-bottom: 10px;
}
