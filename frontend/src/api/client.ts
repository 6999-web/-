...
export const publicationApi = {
  ...
  // Get rejection reasons for evaluations
  getRejectionReasons: (evaluationIds: string) => {
    return apiClient.get('/publication/rejection-reasons', { params: { evaluation_ids: evaluationIds } })
  }
}
