                ...
                >
                  <div class="result-header">
                    <div class="result-title-section">
                      ...
                      <el-tag v-if="result.status === 'rejected_by_president'" type="danger">已驳回</el-tag>
                  ...
                  <div v-if="result.status === 'rejected_by_president' && result.reject_reason" class="reject-reason-display">
                    <el-alert type="error" :closable="false" show-icon>
                      <template #title>
                        <span>驳回原因：{{ result.reject_reason }}</span>
                      </template>
                    </el-alert>
                  </div>
...
const loadPublishedResults = async () => {
  ...
  try {
    ...
    console.log('App Mode:', (import.meta as any).env.VITE_APP_MODE || 'development');
...
@media (max-width: 768px) {
  ...
  .content-header.mobile-full .back-btn {
    display: inline-flex;
    align-items: center;
    gap: 5px;
    padding: 8px 12px;
